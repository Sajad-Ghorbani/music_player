...
class MyAudioHandler extends BaseAudioHandler {
  ...
  Future<void> _lodeEmptyPlaylist() async {
    try {
  ...
  @override
  Future addQueueItems(List<MediaItem> mediaItems) async {
  ...
  @override
  Future androidSetRemoteVolume(int volumeIndex) async {
    _player.setVolume(volumeIndex.toDouble());
  }
